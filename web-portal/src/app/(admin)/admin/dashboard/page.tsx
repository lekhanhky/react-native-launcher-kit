    ...
    <div className="max-w-6xl mx-auto space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex flex-wrap items-center gap-2.5 self-start sm:self-auto">
          <Link
            href="/admin/backup"
            className="px-4 py-2.5 rounded-xl bg-slate-800 hover:bg-slate-700 text-slate-200 text-xs font-bold shadow-md flex items-center gap-1.5 transition border border-slate-700"
          >
            <HardDriveDownload className="w-4 h-4 text-indigo-400" /> Sao Lưu & Phục Hồi
          </Link>
          <Link
